...
from .models import MyUser, Level, Question, Answer, UserInput #, ActivationProfile
...
class UserQuestion(admin.ModelAdmin):
    list_display = ('level_id','question_content')
    list_filter = ('level_id',)

class UserAnswer(admin.ModelAdmin):
    list_display = ('question_id','answer_content','is_correct')
    list_filter = ('question_id',)

# Now register the new UserAdmin...
admin.site.register(MyUser, UserAdmin)
admin.site.register(Level)
admin.site.register(Question, UserQuestion)
admin.site.register(Answer, UserAnswer)
